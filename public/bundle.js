var app = (function () {
	...
	function currentItog(ph) {
		return L.gmxUtil.prettifyDistance(ph.currentScore.reduce(function(p, c) { return p + c.len; }, 0));
	}

	function isSectionsEmpty(ph) {
		var res = false,
